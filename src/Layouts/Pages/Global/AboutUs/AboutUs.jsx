          ...
          <div className="main-content">
            ...
            <div className="features-grid">
              <div className="feature-card">
                ...
                <p>
                  Explore comprehensive information on popular destinations
                  across Bangladesh, from bustling cities to serene landscapes.
                </p>
              </div>
              ...
              <div className="feature-card">
                ...
                <p>
                  Discover local culture, cuisine, and activities that will
                  enrich your travel experience beyond the ordinary.
                </p>
              </div>
              ...
              <div className="feature-card">
                ...
                <h3>Hidden Gems</h3>
                <p>
                  Uncover both famous landmarks and hidden gems that showcase
                  the authentic beauty of Bangladesh.
                </p>
              </div>
            </div>
            ...
            <section className="values-section">
              ...
              <div className="values-grid">
                ...
                <div className="value-item">
                  ...
                  <p>
                    Discover exciting activities and experiences for every type
                    of traveler.
                  </p>
                </div>
              </div>
            ...
            <section className="cta-section">
              <div className="cta-content">
                ...
                <p>
                  Whether you're seeking famous landmarks or hidden treasures,
                  we have everything you need to make your journey
                  unforgettable.
                </p>
